            ...
            <div class="w-full flex flex-col gap-4">
                <div class="w-full md:w-max mx-auto flex flex-col gap-2 items-center">
                    <img id="image" class="rounded-md mx-auto w-52 h-52 object-cover bg-gray-50"
                        src="
                    {{ !empty($user_info->profile_photo_path)
                        ? url('upload/profilepic/' . $user_info->profile_photo_path)
                ...
                <div class="w-full flex flex-col md:flex-row gap-4">
                    <div class="w-full flex flex-col gap-2">
                        ...
                        <input id="first-name" name="name" value="{{ $user_info->name }}" placeholder="Nom"
                            type="text"
                    ...
                    <div class="w-full flex flex-col gap-2">
                        ...
                        <input id="last-name" name="last_name" value="{{ $user_info->last_name }}" placeholder="Prenom"
                            type="text"
                            class="h-12 text-md w-full bg-gray-50 text-gray-900 px-4 py-2 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500" />
                    </div>
                </div>
                <div class="w-full flex flex-col md:flex-row gap-4">
                    <div class="w-full flex flex-col gap-2">
                        ...
                        <input id="phone" name="phone" value="{{ $user_info->phone }}" placeholder="Telephone"
                            type="tel"
                            class="h-12 text-md w-full bg-gray-50 text-gray-900 px-4 py-2 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500" />
                    </div>
                    <div class="w-full flex flex-col gap-2">
                        <label class="text-md flex text-gray-900" for="email">Email</label>
                        <input id="email" name="email" value="{{ $user_info->email }}" placeholder="Email"
                            type="email"
                            class="h-12 text-md w-full bg-gray-50 text-gray-900 px-4 py-2 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500" />
                    </div>
                </div>
                <div class="w-full flex flex-col gap-2">
                    ...
                    <textarea id="address" name="adress" placeholder="Adresse"
                        class="h-24 text-md w-full bg-gray-50 text-gray-900 px-4 py-2 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500">{{ $user_info->adress }}</textarea>
                </div>
