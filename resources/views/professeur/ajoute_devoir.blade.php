...
@section('content')
    ...
    <h1 class="text-2xl md:text-4xl font-black text-gray-900">Nouveau devoir</h1>
    <div class="p-4 text-left bg-white shadow-md w-full rounded-md">
        <form action="{{ route('devoir.save.prof') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="w-full flex flex-col gap-4">
                <div class="w-full flex flex-col md:flex-row gap-4">
                    <div class="w-full flex flex-col gap-2">
                        <label class="text-md flex text-gray-900" for="title">Titre</label>
                        <input id="title" name="nom_tp" placeholder="Titre" type="text"
                    ...
                    <div class="relative w-full flex flex-col gap-2">
                        ...
                        <input data-custom-date readonly id="date" name="date_limite" placeholder="Date limite"
                            type="text"
                ...
                <div class="w-full flex flex-col gap-2">
                    ...
                    <label for="file" class="w-full">
                        <button onclick="clicked(event)"
                            ...
                            type="button">
                            <input data-element-preview data-target="#text" type="file" name="file"
                            ...
                            <span id="text" class="pointer-events-none">Document</span>
                        </button>
                    </label>
                    @error('file')
    ...
    <script defer>
        ...
        Starter.add(createSelectElement, createDateElement, previewElementFile("txt"));
    </script>
@endsection
